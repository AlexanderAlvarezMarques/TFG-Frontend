...
export default function DashBoardPage() {
    ...
    const pageDataInitValue: CustomData = useMemo(() => {
        return {
            data: [],
            pagination: {
    ...
    const requestApiData = useCallback(async (page: number = Number(process.env.NEXT_PUBLIC_DEFAULT_PAGE), itemsPerPage: number = Number(process.env.NEXT_PUBLIC_DEFAULT_ITEMS_PER_PAGE)) => {
    ...
    }, [pageData.pagination.currentPage, pageData.pagination.itemsPerPage, selectedMenu])
    ...
    }, [auth.isLogged, requestApiData, router]);
