...
type SearchBarFormProps = SearchBarParams & {
    action: Function|undefined
}

const SearchForm: React.FC<SearchBarFormProps> = (
    {province, city, date, sport, action}) => {
    ...
    const [formData, setFormData] = useState<SearchBarParams>({
        province: province,
        city: city,
        date: date,
        sport: sport
