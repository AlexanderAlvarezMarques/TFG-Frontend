...
import CourtReservationModal from "@/components/modal/CreateReserveModal/CourtReservationModal";
            ...
            {props.courts.map((court: CourtSchedule, reserveIndex: number) => (
                <div key={reserveIndex} className={`${styles.court}`}>
                    <div className={`${styles.title}`} >
                        {FormatTextTools.capitalizeFirstChar(props.sport)} {court.number}
                    </div>
